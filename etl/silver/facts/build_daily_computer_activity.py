...
OUTPUT_FILE = SILVER_DIR / "facts" / "daily_computer_activity.parquet"
TMP_DIR = SILVER_DIR / "tmp" / "daily_computer_activity"
...
def main():
    ...
    for i, file in enumerate(files):
        ...
        chunk = (
            ...
            .group_by(["day", "destination_computer"])
            .agg(status_metrics())
    ...
    print()
    print("=" * 60)
    print(f"Registros: {daily.height:,}")
    print(f"Computadores: {daily['computer'].n_unique():,}")
    print(f"Dias: {daily['day'].n_unique()}")
